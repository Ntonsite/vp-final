				...
				<div class="modal-body">
					<form enctype="multipart/form-data" method="post" action="<?php echo site_url('License/create') ?>">
						<div class="form-group">
							...
							<input required="" type="text" class="form-control" name="license_name"
								   aria-describedby="emailHelp" placeholder="License Name">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Description</label>
							<input required="" type="text-area" class="form-control" name="description"
								   aria-describedby="emailHelp" placeholder="Description">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Activations Number</label>
							<input required="" type="number" class="form-control" name="activations_number"
								   aria-describedby="emailHelp" placeholder="Activations number">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input required="" type="file" accept="image/*,.pdf,.doc,.docx" class="form-control"
			...
			foreach ($result as $row) { ?>
				<tr>
					...
					<td><a class="btn btn-sm btn-primary"
						   href="<?php echo base_url('uploads/licenses'); ?>/<?php echo $row->file; ?>">View</a>
						<?php
						if ($portal == 3 || $role ==1) {
							?>
							<a class="btn btn-sm btn-warning"
							   href="<?php echo site_url('License/edit'); ?>/<?php echo $row->id; ?>">Edit</a>
							<a onClick="javascript: return confirm('Please confirm deletion');"
							   class="btn btn-sm btn-danger"
							   href="<?php echo site_url('License/delete'); ?>/<?php echo $row->id; ?>">Delete</a>
							<?php
						}
						?>
					</td>
