...
<head>
	...
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url('assets/DataTables/css/dataTables.bootstrap.min.css') ?>">
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url('assets/DataTables/css/jquery.dataTables.min.css') ?>">
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url('assets/DataTables/css/dataTables.semanticui.min.css') ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/sweet-alert.css') ?>">
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url('assets/DataTables/css/dataTables.foundation.min.css') ?>">
...
<div class="container-fluid">
	...
	<nav class="navbar navbar-expand-md navbar-light bg-light">
		<a class="navbar-brand" href="<?php echo site_url('dashboard') ?>">Contract & License Portal</a>
		...
		<div id="navbarNavDropdown" class="navbar-collapse collapse">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active">
					<a class="nav-link" href="<?php echo site_url('contract') ?>">Contract<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo site_url('license') ?>">License</a>
				</li>
				<?php $portal = $this->session->userdata('role'); ?>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?php echo site_url('attachment') ?>">Attachments</a>
				</li>
			</ul>
			<ul class="navbar-nav">
				<div class="dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<a onClick="javascript: return confirm('Are you sure, you want to logout?');"
						   class="dropdown-item" href="<?php echo site_url('auth/logout') ?>">Logout<i
								class="fas fa-out"></i></a>
					</div>
				</div>
			</ul>
		</div>
				...
				<div class="modal-body">
					<form method="post" action="<?php echo site_url('user/changePassword') ?>"
						...
						<div class="form-group">
							...
							<input required="" type="password" class="form-control" name="new_cpassword"
